...
public class Model2 extends Animable {
	...
	public static Model2 fetchModel(int j) {
		if (modelHeader == null)
			return null;
		if(j == 0)
			return null;
	...
	private Model2(boolean flag) {
		aBoolean1618 = true;
		rendersWithinOneTile = false;
	}

	public Model2(int i, Model2 amodel[]) {
		aBoolean1618 = true;
		rendersWithinOneTile = false;
		anInt1620++;
		boolean flag = false;
	...
	public Model2(boolean flag, boolean flag1, boolean flag2, Model2 model) {
		aBoolean1618 = true;
		rendersWithinOneTile = false;
		anInt1620++;
		numberOfVerticeCoordinates = model.numberOfVerticeCoordinates;
	...
	public Model2(boolean flag, boolean flag1, Model2 model) {
		aBoolean1618 = true;
		rendersWithinOneTile = false;
		anInt1620++;
		numberOfVerticeCoordinates = model.numberOfVerticeCoordinates;
	...
	public void method464(Model2 model, boolean flag) {
		numberOfVerticeCoordinates = model.numberOfVerticeCoordinates;
		numberOfTriangleFaces = model.numberOfTriangleFaces;
		numberOfTexturesFaces = model.numberOfTexturesFaces;
	...
	private final int method465(Model2 model, int i) {
		int j = -1;
	...
	public void applyTransform(int i) {
		...
		for (int k = 0; k < class36.stepCount; k++) {
			...
			method472(class18.opcodes[l], class18.skinList[l],
	...
	public void method471(int ai[], int j, int k) {
		...
		for (int j1 = 0; j1 < class36.stepCount; j1++) {
			...
			if (k1 != i1 || class18.opcodes[k1] == 0)
				method472(class18.opcodes[k1], class18.skinList[k1],
		...
		try {
			for (int l1 = 0; l1 < class36_1.stepCount; l1++) {
				...
				if (i2 == i1 || class18.opcodes[i2] == 0)
					method472(class18.opcodes[i2], class18.skinList[i2],
	...
	private final void translateToScreen(boolean flag, boolean needAddToSelectedObjects, int i, int id) {
		...
		for (int triangleId = 0; triangleId < numberOfTriangleFaces; triangleId++) {
			...
			if (flag && (vertexXA == -5000 || vertexXB == -5000 || vertexXC == -5000)) {
				...
				int j5 = (anIntArray1667[face_a_pos] + anIntArray1667[face_b_pos] + anIntArray1667[face_c_pos])
						/ 3 + anInt1653;
			...
			if ((vertexXA - vertexXB) * (projected_vertex_y[face_c_pos] - projected_vertex_y[face_b_pos])
				...
				hasAnEdgeToRestrict[triangleId] = vertexXA < 0 || vertexXB < 0 || vertexXC < 0
						...
						int k5 = (anIntArray1667[face_a_pos] + anIntArray1667[face_b_pos] + anIntArray1667[face_c_pos])
								/ 3 + anInt1653;
