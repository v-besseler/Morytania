...
public final class WeaponAnimations {
	...
	public static CharacterAnimations getUpdateAnimation(Item item) {
		...
		else if (weaponName.contains("wand") || weaponName.contains("staff")  || weaponName.contains("vitur") || weaponName.contains("trident")
		...
		else if (weaponName.contains("2h sword") || weaponName.contains("godsword") || weaponName.contains("bulwark")
	...
	public static int getAttackAnimation(Player c) {
		...
		if (weaponName.contains("halberd") || weaponName.contains("vitur")) {
			return 440;
		}
		...
		if(weaponName.endsWith("warhammer") || weaponName.endsWith("battleaxe"))
			return 401;
		if (weaponName.contains("2h sword") || weaponName.contains("godsword") || weaponName.contains("bulwark")
	...
	public static int getBlockAnimation(Player c) {
		...
		if (shield.contains("2h"))
			return 7050;
		if (shield.contains("book") && (weapon.contains("wand") && weapon.contains("vitur")))
			return 420;
