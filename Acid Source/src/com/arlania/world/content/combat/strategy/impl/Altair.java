...
public class Altair {
    public static int[] ALTAIR_ARMOR = new int[] {20203, 20204, 20205, 20206, 20207};
    public static int[] ALTAIR_SWORDS = new int[] {20201, 20202};
    ...
    public static void handleDrop(Player player, NPC npc) {
        ...
        if(randomNumber < 2) {
            int drop = RNG.randElement(ALTAIR_ARMOR);
            ...
            int drop = RNG.randElement(ALTAIR_SWORDS);
            // any sword 1/1000
            GroundItemManager.spawnGroundItem(player, new GroundItem(new Item(drop), npc.getPosition().copy(), player.getUsername(), false, 100, false, -1));
        }
    }
