...
public class CrimsonDragon {

    public static int[] CRIMSON_DROPS = new int[] {20293, 20294, 20295, 20296, 20297, 20298, 20299, 20300, 20301};
    ...
    public static void handleDrop(Player player, NPC npc) {
        ...
        if(randomNumber < 10) {
            int drop = RNG.randElement(CRIMSON_DROPS);
