...
public class CombatRangedAmmo {
	...
	public enum RangedWeaponData {
		...
		GODBOW(new int[] {19143, 19149, 19146, 20998}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.BROAD_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.SHORTBOW),

		ROCKET_LAUNCHER(new int[] {20231}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.CROSSBOW),
		ACID_BOW(new int[] {20282}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.SHORTBOW),
		BRAZILIAN_BFG(new int[] {20285}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.CROSSBOW),
		BFG(new int[] {20283}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.CROSSBOW),
		SHAMAN_BOW(new int[] {20307}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.SHORTBOW),
		LAVA_BOW(new int[] {20326}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.SHORTBOW),
		SOLAR_BOW(new int[] {20348}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.SHORTBOW),
		ICE_BOW(new int[] {20362}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.SHORTBOW),

		MINIGUN(new int[] {20366}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.CROSSBOW),
		GOLD_MINIGUN(new int[] {20367}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.CROSSBOW),
		NATURE_MINIGUN(new int[] {20368}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.CROSSBOW),
		FROST_MINIGUN(new int[] {20369}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.CROSSBOW),
		LAVA_MINIGUN(new int[] {20370}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.CROSSBOW),
		SHADOW_MINIGUN(new int[] {20371}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.CROSSBOW),
		DRAGON_MINIGUN(new int[] {20372}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.CROSSBOW),
		RAINBOW_MINIGUN(new int[] {20373}, new AmmunitionData[] {AmmunitionData.NO_AMMO}, RangedWeaponType.CROSSBOW),
		...
		ZARYTE_BOW(new int[] {4706, 18971}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.DARK_BOW),
	...
	public enum AmmunitionData {
		...
		BLOWPIPE(new int[] {12926}, -1, 1123, 10, 20, 85, 23, 25),
		...
		NO_AMMO(new int[] {-1}, -1, -1, 2, 40, 7, 45, 37),
