...
public class TeleportBosses extends Teleporting  {
	...
	public static enum Bosses {
		...
		TELEPORT_5(new String[] {"Frost Dragons", "(wilderness)"}, new int[] {2961, 3882, 0}),
		TELEPORT_6(new String[] {"Dagannoth", "Kings"}, new int[] {1912, 4367, 0}),
		TELEPORT_7(new String[] {"Tormented", "Demons"}, new int[] {2540, 5774, 0}),
		TELEPORT_8(new String[] {"C. Elemental", "(wilderness)"}, new int[] {3276, 3915, 0}),
		TELEPORT_9(new String[] {"Corporeal", "Beast"}, new int[] {2886, 4376, 0}),
		TELEPORT_10(new String[] {"Barrelchest", "Area"}, new int[] {2973, 9517, 3}),
		TELEPORT_11(new String[] {"Lizardman", "Shaman"}, new int[] {2718, 9811, 1}),
		TELEPORT_12(new String[] {"Bork", "Cave"}, new int[] {3104, 5537, 0});
		/**
